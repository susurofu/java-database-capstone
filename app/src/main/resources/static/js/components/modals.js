...
export function openModal(type) {
  ...
  if (type === 'addDoctor') {
    ...
    modalContent = `
        <h2>Patient Login</h2>
        <input type="text" id="loginPatientEmail" placeholder="Email" class="input-field">
        <input type="password" id="loginPatientPassword" placeholder="Password" class="input-field">
